...
import { X, Calendar, Lock, Unlock, Save, Tag, Trash2, ArrowLeft, Settings2, Edit3, MoreHorizontal, ChevronRight, Maximize, Minimize } from 'lucide-react';
          ...
          <div className="flex justify-between items-center px-4 md:px-6 py-4 border-b border-gray-100 dark:border-gray-800 bg-white dark:bg-black sticky top-0 z-50">
            ...
            <div className="flex items-center gap-2">
               ...
               <button 
                 ...
                 className="p-2.5 text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-900 rounded-xl transition-all"
                 title="Zen Mode"
               >
                  <Maximize size={18} />
               </button>
        ...
        <div className="flex-1 flex overflow-hidden relative">
             ...
             {isZenMode && (
                <button 
                  ...
                  className="absolute top-6 right-6 z-50 p-3 bg-gray-100 dark:bg-gray-800 rounded-full text-gray-500 hover:text-black dark:hover:text-white transition-colors shadow-sm opacity-50 hover:opacity-100"
                >
                   <Minimize size={20} />
                </button>
             )}
             ...
             {/* Main Editor Area */}
             <div className={`flex-1 flex flex-col h-full relative overflow-y-auto custom-scrollbar bg-white dark:bg-black transition-all duration-500 ${mobileTab === 'editor' ? 'flex' : 'hidden md:flex'}`}>
                <div className={`max-w-3xl mx-auto w-full px-6 pb-32 transition-all duration-500 ${isZenMode ? 'py-20 md:py-32' : 'py-8 md:py-12'}`}>
                   ...
                   {/* Template Selector (Only when NOT zen) */}
             ...
             {/* Sidebar: Metadata (Clean White) - Hidden in Zen Mode */}
             {!isZenMode && (
